...
public class ProviderApplyWhereMethodGenerator extends
    ...
    private static final String[] BEGINNING_METHOD_LINES = {
        ...
        "parmPhrase2_th = \"%s #{example.oredCriteria[%d].allCriteria[%d].value,typeHandler=%s}"
        ...
        "parmPhrase2 = \"%s #{oredCriteria[%d].allCriteria[%d].value}"
            + " and #{oredCriteria[%d].criteria[%d].secondValue}\";",
        "parmPhrase2_th = \"%s #{oredCriteria[%d].allCriteria[%d].value,typeHandler=%s}"
