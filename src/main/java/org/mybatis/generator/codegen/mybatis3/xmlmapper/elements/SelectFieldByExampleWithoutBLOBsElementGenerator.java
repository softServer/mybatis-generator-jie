...
public class SelectFieldByExampleWithoutBLOBsElementGenerator extends
        AbstractXmlElementGenerator {

    public SelectFieldByExampleWithoutBLOBsElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id",
                introspectedTable.getSelectFieldByExampleStatementId()));
